...
{
        const infoItems=[
                { title: 'Crop Recommedation', image: '/about/icon-1.png' },
                { title: 'Market Price Monitoring', image: '/about/icon-2.png' },
                { title: 'Remote Farm Monitoring', image: '/about/icon-3.png' },
                { title: 'Marget Yield Analysis', image: '/about/icon-4.png' },
                { title: 'Rental Service', image: '/about/icon-5.png' },
                { title: 'Weather Monitoring ', image: '/about/icon-6.png' },
        ];
